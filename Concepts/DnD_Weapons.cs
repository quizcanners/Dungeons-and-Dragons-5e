...
namespace Dungeons_and_Dragons
{
    ...
    [Serializable] public class WeaponProficiencies : ProficiencyDictionary<Weapon.WeaponType> { }

    public class Weapon : IGotName, ISearchable
    {
        private string _name;

       // private WeaponType _weaponType = WeaponType.Shortsword; // Not implemented yet
        ...
        public enum WeaponType { Crossbow, Hand, Longsword, Rapier, Shortsword, SimpleWeapos }
        ...
        private static readonly StaticDictionaryGeneric<Weapon> _allElementsContainer = new StaticDictionaryGeneric<Weapon>(
